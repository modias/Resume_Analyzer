...
export const mentors: Mentor[] = [
  ...
  },
  {
    ...
    linkedinSlug: "nina-rodriguez-data",
    tenure: "2 yrs",
    skillOverlap: ["Python", "Experimentation", "SQL"],
  },
  {
    id: 8,
    name: "Ethan Walker",
    ...
    linkedinSlug: "ethan-walker-platform",
    tenure: "3 yrs",
    skillOverlap: ["Kafka", "Spark", "Go"],
  },
  {
    id: 9,
    name: "Mei Lin",
    ...
    linkedinSlug: "mei-lin-ml",
    tenure: "1.8 yrs",
    skillOverlap: ["PyTorch", "CUDA", "MLOps"],
  },
  {
    id: 10,
    name: "Jordan Lee",
    ...
    linkedinSlug: "jordan-lee-analytics",
    tenure: "4 yrs",
    skillOverlap: ["Tableau", "SQL", "Leadership"],
  },
  {
    id: 11,
    name: "Olivia Grant",
    ...
    isFollowing: false,
    avatar: "OG",
    avatarColor: "from-gray-500 to-slate-400",
    linkedinSlug: "olivia-grant-ds",
    tenure: "2.2 yrs",
    skillOverlap: ["Statistics", "Python", "SQL"],
  },
  {
    id: 12,
    name: "Arjun Malhotra",
    ...
    linkedinSlug: "arjun-malhotra-ai",
    tenure: "1.3 yrs",
    skillOverlap: ["LLMs", "Python", "Evaluation"],
  },
];
